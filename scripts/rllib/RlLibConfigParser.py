...
class RlLibConfigParser:
    ...
    def validate_config(self) -> bool:
        ...
        """
        if "algorithm" not in self.model_config:
            print(f"Error: algorithm not find in config file")
            return False

        if "stop" not in self.model_config:
            print(f"Error: stop not find in config file")
            return False

        if "checkpoint_frequency" not in self.model_config:
            print(f"Error: checkpoint_frequency not find in config file")
            return False

        if "config" not in self.model_config:
            print(f"Error: config not find in config file")
            return False
